-- Recreate Mercury tables after CASCADE drop
-- This is the corrected version from 20260215_add_mercury_integration.sql

-- Tables should already be dropped, but just in case:
DROP TABLE IF EXISTS account_balance_history CASCADE;
DROP TABLE IF EXISTS transaction_categorization_rules CASCADE;
DROP TABLE IF EXISTS merchant_mapping_cache CASCADE;
DROP TABLE IF EXISTS mercury_sync_logs CASCADE;
DROP TABLE IF EXISTS mercury_connections CASCADE;
