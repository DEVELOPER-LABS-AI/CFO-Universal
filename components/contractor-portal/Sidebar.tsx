...
const navItems: NavItem[] = [
  { label: 'Dashboard', href: '/contractor-portal', icon: Home },
  { label: 'Invoices', href: '/contractor-portal/invoices', icon: FileText },
  { label: 'Payments', href: '/contractor-portal/payments', icon: CreditCard },
]

interface ContractorPortalSidebarProps {
  contractorName: string
  userName: string
}

export function ContractorPortalSidebar({ contractorName, userName }: ContractorPortalSidebarProps) {
    ...
    <aside className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col border-r border-gray-200 bg-white">
      <div className="flex flex-col flex-1 min-h-0">
        ...
        <div className="flex items-center h-16 px-6 border-b border-gray-200">
          <Link href="/contractor-portal" className="flex items-center space-x-2">
