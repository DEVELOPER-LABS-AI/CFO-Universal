# Apply Mercury Migrations

Run this SQL in your Supabase SQL Editor (https://supabase.com/dashboard/project/fqljijavvxkthzozslzx/sql/new):
...
After running this SQL, the Mercury integration will work!
